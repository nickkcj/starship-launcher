...
# Arquivos
SRC_ETAPA1 = src/main.cpp src/entities/bateria.cpp src/entities/foguete.cpp src/entities/nave.cpp src/core/game.cpp src/core/renderer.cpp src/systems/colisao.cpp src/systems/carregador.cpp src/systems/dificuldade.cpp
...
# Regra padrão: compila versão atual (Etapa 7: Detecção de colisão)
all: $(TARGET)

# Compilar versão atual
$(TARGET): $(SRC_ETAPA1)
	@echo "Compilando Etapa 7 (Detecção de colisão)..."
